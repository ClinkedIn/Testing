...
describe('Successful Signup as an employee',()=>{
    ...
    it.skip('Valid signup from homepage',()=>{ 
        ...
        cy.get(Signup.Password).type(Cypress.env('myPassword')) //show password
...
describe('Invalid Signup',()=>{
    ...
    it.skip('Email is already registered',()=>{
    ...
    it.skip("Sign up via Google", () => { 
        ...
        //     { 
        //       args: { 
        //         email: Cypress.env("myEmail"), 
        //         password: Cypress.env("myPassword") ,
        //         Signup: Signup
        //       } 
        //     },
